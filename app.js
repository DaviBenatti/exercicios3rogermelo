...
banda.albuns = [
  { nome: 'Houses of the Holy', ano: 1973, capa: 'https://upload.wikimedia.org/wikipedia/en/9/9f/Led_Zeppelin_-_Houses_of_the_Holy.jpg' }, 
  { nome: 'Physical Graffiti', ano: 1975, capa: 'https://upload.wikimedia.org/wikipedia/en/e/e3/Led_Zeppelin_-_Physical_Graffiti.jpg' }
]
...
console.log(pokemon.moves[0].versionGroupDetails[1].versionGroup.url[0])
...
const placeholders = ['Nirvana','Microsoft','Rock','Machine']

const paragrafo = `Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é ${placeholders[1]}, um dos gêneros da banda ${placeholders[0]} é ${placeholders[2]} e que a propriedade moveLearnMethod do Articuno contém um objeto com uma propriedade name que armazena ${placeholders[3]}.`
